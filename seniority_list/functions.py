...
def delayed_monthly_sep_job_tables(job_levels,
    ...
    inputs
        job_levels
            the number of job levels in the model (from the settings dictionary)
        eg_job_counts
...
def job_gain_loss_table(months, job_levels, init_job_counts,
    ...
    job change schedules defined by the settings dictionarys.
    ...
    inputs
        ...
        init_job_counts (tuple of two numpy arrays)
            ...
            combined counts.
        job_changes (list)
            The list of job changes from the settings dictionarys.
        standalone (boolean)
...
def convert_to_enhanced(eg_job_counts, j_changes, job_dict):
    ...
    inputs
        ...
        j_changes
            input from settings dictionary describing change of job quantity over
            months of time (list)
